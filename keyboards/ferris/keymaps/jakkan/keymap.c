...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT(
    ...
    LCTL_T(KC_A),       LALT_T(KC_R),       LGUI_T(KC_S),       LSFT_T(KC_T),       RALT_T(KC_G),       LCTL_T(KC_O),       LALT_T(KC_I),       LGUI_T(KC_E),       LSFT_T(KC_N),       RALT_T(KC_M),
    KC_Z,               KC_X,               KC_C,               KC_D,               KC_V,               KC_SLSH,            KC_DOT,             KC_COMM,            KC_H,               KC_K,
  ...
  [NUM] = LAYOUT(
    ...
    KC_6,               KC_7,               KC_8,               KC_9,               KC_0,               KC_LCTL,            KC_LALT,            KC_LGUI,            KC_LSFT,            KC_RALT, 
  ...
  [SYM] = LAYOUT(
    ...
    KC_CIRC,            KC_AMPR,            KC_ASTR,            KC_LPRN,            KC_RPRN,            KC_LCTL,            KC_LALT,            KC_LGUI,            KC_LSFT,            KC_RALT, 
    KC_EXLM,            KC_AT,              KC_HASH,            KC_DLR,             KC_PERC,            KC_NO,              KC_NO,              KC_NO,              KC_NO,              KC_NO,
                                                                KC_COLN,            KC_TILDE,           MO(FUN),            KC_NO                                
  ),
  [NAV] = LAYOUT(
    KC_NO,              KC_NO,              KC_NO,              KC_NO,              KC_NO,              KC_NO,              KC_NO,              KC_NO,              KC_NO,              KC_NO,
    KC_LCTL,            KC_LALT,            KC_LGUI,            KC_LSFT,            KC_RALT,            KC_RGHT,            KC_UP,              KC_DOWN,            KC_LEFT,            KC_NO,
    KC_NO,              KC_NO,              KC_NO,              KC_NO,              KC_NO,              KC_END,             KC_PGUP,            KC_PGDN,            KC_HOME,            KC_NO,                                    
                                                                MO(SHF),            KC_NO,              KC_DEL,             KC_ESC                               
  ),
  [MOU] = LAYOUT(
    KC_NO,              KC_NO,              KC_NO,              KC_NO,              KC_NO,              KC_NO,              KC_NO,              KC_NO,              KC_NO,              KC_NO,
    KC_LCTL,            KC_LALT,            KC_LGUI,            KC_LSFT,            KC_RALT,            KC_MS_R,            KC_MS_U,            KC_MS_D,            KC_MS_L,            KC_NO,
    KC_NO,              KC_NO,              KC_NO,              KC_NO,              KC_NO,              KC_WH_R,            KC_WH_U,            KC_WH_D,            KC_WH_L,            KC_NO,
  ...
  [FUN] = LAYOUT(
    ...
    KC_F6,              KC_F7,              KC_F8,              KC_F9,              KC_F10,             KC_LCTL,            KC_LALT,            KC_LGUI,            KC_LSFT,            KC_RALT, 
